...
const PARTY_PROFILES: Record<string, PartyProfile> = {
  ...
  "AfD": {
    ...
    scenarios: [
      { group: { de: "Angestellte & Arbeitnehmer", "de-leicht": "Angestellte", en: "Employees" }, icon: "👔", verdict: "gemischt", impact: { de: "Niedrigere Energiekosten durch Rückkehr zu konventionellen Energiequellen entlasten Privathaushalte. Allerdings könnte die EU-Skepsis den Zugang zum europäischen Binnenmarkt gefährden, was Arbeitsplätze in exportabhängigen Branchen bedroht. Weniger Zuwanderung reduziert die Konkurrenz am Arbeitsmarkt, verschärft aber den Fachkräftemangel.", "de-leicht": "Energie wird billiger. Aber weniger Handel mit Europa kann Jobs gefährden. Weniger Einwanderer heißt weniger Konkurrenz, aber auch weniger Fachkräfte.", en: "Lower energy costs from returning to conventional energy sources ease household budgets. However, EU skepticism could endanger access to the European single market, threatening jobs in export-dependent industries. Less immigration reduces labor market competition but worsens the skilled worker shortage." } },
      { group: { de: "Selbstständige & Freiberufler", "de-leicht": "Selbstständige", en: "Self-employed" }, icon: "💼", verdict: "gemischt", impact: { de: "Weniger Regulierung und niedrigere Sozialabgaben senken die laufenden Kosten. Gleichzeitig könnten Handelsbarrieren mit EU-Partnern den Zugang zu wichtigen Märkten einschränken. Die Abkehr von EU-Normen kann für international tätige Selbstständige zusätzliche Hürden schaffen.", "de-leicht": "Weniger Regeln und Abgaben. Aber der Handel mit EU-Ländern könnte schwieriger werden. Das betrifft besonders Selbstständige, die mit dem Ausland arbeiten.", en: "Less regulation and lower social contributions reduce operating costs. At the same time, trade barriers with EU partners could limit access to important markets. Moving away from EU standards can create additional hurdles for internationally active self-employed." } },
      { group: { de: "Landwirte", "de-leicht": "Bauern", en: "Farmers" }, icon: "🌾", verdict: "positiv", impact: { de: "Deutlich weniger Umweltauflagen und Rücknahme der EU-Agrarpolitik erleichtern die Bewirtschaftung. Niedrigere Energiekosten senken die Produktionskosten. Schutz vor billigen EU-Importen stärkt die Wettbewerbsposition heimischer Landwirte. Gentechnik und konventionelle Methoden werden weniger eingeschränkt.", "de-leicht": "Viel weniger Umwelt-Regeln. Günstigere Energie. Schutz vor billigen Lebensmitteln aus dem Ausland. Mehr Freiheit bei der Bewirtschaftung.", en: "Significantly fewer environmental regulations and rollback of EU agricultural policy ease farming. Lower energy costs reduce production costs. Protection from cheap EU imports strengthens the competitive position of domestic farmers. Genetic engineering and conventional methods face fewer restrictions." } },
      { group: { de: "Mittelstand & KMU", "de-leicht": "Kleine Firmen", en: "SMEs" }, icon: "🏭", verdict: "gemischt", impact: { de: "Weniger Bürokratie und niedrigere Energiekosten entlasten den Mittelstand. Allerdings droht durch die EU-kritische Haltung der Verlust des Zugangs zum europäischen Binnenmarkt, der für viele KMU existenziell ist. Geringere Zuwanderung verschärft den ohnehin gravierenden Fachkräftemangel.", "de-leicht": "Weniger Regeln und billigere Energie. Aber der Handel mit Europa könnte schwieriger werden. Es gibt noch weniger Fachkräfte, weil weniger Menschen einwandern.", en: "Less bureaucracy and lower energy costs ease the burden on SMEs. However, the EU-critical stance risks losing access to the European single market, which is essential for many SMEs. Reduced immigration worsens the already severe skilled labor shortage." } },
      { group: { de: "Rentner & Senioren", "de-leicht": "Rentner", en: "Retirees" }, icon: "🏡", verdict: "positiv", impact: { de: "Niedrigere Energiekosten für Heizen und Strom entlasten besonders Rentnerhaushalte. Stabile Renten werden versprochen. Allerdings bedeutet weniger Zuwanderung langfristig weniger Beitragszahler in die Rentenkasse, was die Finanzierung der Renten gefährden könnte.", "de-leicht": "Heizen und Strom werden billiger. Renten sollen sicher bleiben. Aber weniger Einwanderer heißt auch weniger Leute, die in die Rentenkasse einzahlen.", en: "Lower energy costs for heating and electricity particularly benefit retiree households. Stable pensions are promised. However, less immigration means fewer contributors to the pension system long-term, which could endanger pension financing." } },
      { group: { de: "Immobilienbesitzer & Vermieter", "de-leicht": "Hausbesitzer", en: "Property owners" }, icon: "🏠", verdict: "positiv", impact: { de: "Keine verpflichtende energetische Sanierung, was erhebliche Investitionskosten erspart. Weniger Bauvorschriften und Regulierung senken die Bau- und Instandhaltungskosten. Keine Verschärfung der Mietpreisbremse. Niedrigere Energiekosten machen Immobilien als Geldanlage attraktiver.", "de-leicht": "Keine teuren Pflicht-Sanierungen. Weniger Bau-Regeln. Mieten werden nicht stärker reguliert. Billigere Energie macht Häuser wertvoller.", en: "No mandatory energy renovation, saving significant investment costs. Fewer building regulations reduce construction and maintenance costs. No tightening of rent controls. Lower energy costs make real estate more attractive as an investment." } },
    ],
  },
  "LINKE": {
